...
Vec3 getBoneXYZ(kaddr humanAddr, kaddr boneAddr, int Part) {
    ...
    D3DXMATRIX Component_ToWorld_Matrix = ToMatrixWithScale(Actor.Rotation, Actor.Translation,
                                                            Actor.Scale3D);
...
PlayerBone getPlayerBone(uintptr_t pBase, struct D3DMatrix viewMatrix) {
    ...
    boneAddr = getPtr(boneAddr + 0x5a0);
...
void DrawESP(ESP esp, int screenWidth, int screenHeight) {
    ...
    vworld = getPtr(libbase + 0x728D810);
    CM = getPtr(vworld + 32);
    JZDZ = CM + 512;
    struct Vec3 exyz;
    ...
    kaddr uWorlds = getPtr(libbase + 0x6E208CC);
    ...
    for (int i = 0; i < entityCount; i++) {
        ...
        kaddr gname_buff[30];
        kaddr gname = getPtr(libbase + 0x6E17138);
        ...
        if (strstr(name, "Flare")) {//Items
            ...
            if (isFlare)
                if (Location.Z != 1.0f) {
                    esp.DrawRGMItems1(ItemName, Distance, Vec22(Location.X, Location.Y), 10.0f);
                }
        }
        if (strstr(name, "Ghillie")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "PickUpListWrapperActor")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "AirDropPlane")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Ammo_762mm")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Ammo_556mm")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Helmet_Lv1")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Helmet_Lv2")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Helmet_Lv3")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Armor_Lv1")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Armor_Lv2")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Armor_Lv3")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "FirstAidbox")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Grenade_Shoulei")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Grenade_Smoke")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "Grenade_Burn")) {//Items
            char ItemName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 100 || Location.X < -50)
        ...
        if (strstr(name, "UAZ")) {
            ...
            if (isUAZ)
                if (Location.Z != 1.0f) {
                    esp.DrawVehicles(VehicleName, Distance, Vec22(Location.X, Location.Y),
                                     textsize);
                }
        }
        if (strstr(name, "Buggy")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isBuggy)
                if (Location.Z != 1.0f) {
                    esp.DrawBuggy(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "Motorcycle")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isBike)
                if (Location.Z != 1.0f) {
                    esp.DrawBike(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "PG117")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isBoat)
                if (Location.Z != 1.0f) {
                    esp.DrawBoat(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "MotorcycleC")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isTrike)
                if (Location.Z != 1.0f) {
                    esp.DrawTrike(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "Dacia")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isDacia)
                if (Location.Z != 1.0f) {
                    esp.DrawDacia(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "AquaRail")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isJet)
                if (Location.Z != 1.0f) {
                    esp.DrawJet(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "MiniBus")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isBus)
                if (Location.Z != 1.0f) {
                    esp.DrawBus(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "Mirado")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isMirado)
                if (Location.Z != 1.0f) {
                    esp.DrawMirado(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "Scooter")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isScooter)
                if (Location.Z != 1.0f) {
                    esp.DrawScooter(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "Rony")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isRony)
                if (Location.Z != 1.0f) {
                    esp.DrawRony(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "Snowbike")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isSnowbike)
                if (Location.Z != 1.0f) {
                    esp.DrawSnowBike(VehicleName, Distance, Vec22(Location.X, Location.Y),
                                     textsize);
                }
        }
        if (strstr(name, "Snowmobile")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isSnowmobile)
                if (Location.Z != 1.0f) {
                    esp.DrawSnowmobile(VehicleName, Distance, Vec22(Location.X, Location.Y),
                                       textsize);
                }
        }
        if (strstr(name, "Tuk")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isTempo)
                if (Location.Z != 1.0f) {
                    esp.DrawTuk(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "PickUp")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isTruck)
                if (Location.Z != 1.0f) {
                    esp.DrawTruck(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "BRDM")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isBRDM)
                if (Location.Z != 1.0f) {
                    esp.DrawBRDM(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "LadaNiva")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isLadaNiva)
                if (Location.Z != 1.0f) {
                    esp.DrawLadaNiva(VehicleName, Distance, Vec22(Location.X, Location.Y),
                                     textsize);
                }
        }
        if (strstr(name, "Bigfoot")) {//Vehicle
            char VehicleName[50];
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            if (Location.Z == 1.0f || Location.X > width + 200 || Location.X < -200)
            ...
            if (isMonsterTruck)
                if (Location.Z != 1.0f) {
                    esp.DrawMonster(VehicleName, Distance, Vec22(Location.X, Location.Y), textsize);
                }
        }
        if (strstr(name, "BP_Grenade_Shoulei_C") ||
            strstr(name, "BP_Grenade_Burn_C")) {//Grenade Warning
            pvm(getPtr(pBase + 0x140) + 0x150, &exyz, sizeof(exyz));
            Location = World2Screen(vMat, exyz);
            float screenW =
                    (vMat._14 * exyz.X) + (vMat._24 * exyz.Y) + (vMat._34 * exyz.Z + vMat._44);
            ...
            if (!isGrenadeWarning)
                continue;
            esp.DrawText(Color(157, 43, 34), "Warning Granade ⚠️",
                         Vec22(screenWidth / 2, screenHeight / 15), textsize);
            if (Location.Z != 1.0f) {
                if (type == 1)
                    esp.DrawText(Color(157, 43, 34), "Granade", Vec22(Location.X, Location.Y),
                                 textsize);
                else
                    esp.DrawText(Color(157, 43, 34), "Molotov", Vec22(Location.X, Location.Y),
                                 textsize);
            }
        }
        if (strstr(name, "BP_PlayerPawn")) {
            ...
            if (strlen(PlayerNameByte) < 4)
                continue;
            PlayerWeapon p;
            p.id = Read<int>(getPtr(getPtr(getPtr(pBase + 0x12C) + 0x0) + 0xa60) + 0xCC);
            p.ammo = Read<int>(getPtr(getPtr(pBase + 0x12C) + 0x0) + 0x954);
            p.ammo2 = Read<int>(getPtr(getPtr(pBase + 0x12C) + 0x0) + 0x968);
            ...
            kaddr qunViewAngle_x =
                    getPtr(getPtr(getPtr(getPtr(uWorlds + 36) + 96) + 32) + 808) + 0x358;
            ...
            Vec2 angleJudgement = rotateCoord(angle, (Self_x - object_x) / 200,
                                              (Self_y - object_y) / 200);
            ...
            float center = y + my + (screenHeight / 2) / magic_number;
            ...
            if (HeadLocation.Z != 1) {
                if (x > -50 && x < screenWidth + 50) {//onScreen
                    if (isSkelton1) {//Skelton
                        ...
                        esp.DrawLine(Color().Red(), 2.1, Vec22(x, y),
                                     Vec22(Bone.neck.X, Bone.neck.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.neck.X, Bone.neck.Y),
                                     Vec22(Bone.cheast.X, Bone.cheast.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.cheast.X, Bone.cheast.Y),
                                     Vec22(Bone.pelvis.X, Bone.pelvis.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.neck.X, Bone.neck.Y),
                                     Vec22(Bone.lSh.X, Bone.lSh.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.neck.X, Bone.neck.Y),
                                     Vec22(Bone.rSh.X, Bone.rSh.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.lSh.X, Bone.lSh.Y),
                                     Vec22(Bone.lElb.X, Bone.lElb.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.rSh.X, Bone.rSh.Y),
                                     Vec22(Bone.rElb.X, Bone.rElb.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.lElb.X, Bone.lElb.Y),
                                     Vec22(Bone.lWr.X, Bone.lWr.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.rElb.X, Bone.rElb.Y),
                                     Vec22(Bone.rWr.X, Bone.rWr.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.pelvis.X, Bone.pelvis.Y),
                                     Vec22(Bone.lTh.X, Bone.lTh.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.pelvis.X, Bone.pelvis.Y),
                                     Vec22(Bone.rTh.X, Bone.rTh.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.lTh.X, Bone.lTh.Y),
                                     Vec22(Bone.lKn.X, Bone.lKn.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.rTh.X, Bone.rTh.Y),
                                     Vec22(Bone.rKn.X, Bone.rKn.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.lKn.X, Bone.lKn.Y),
                                     Vec22(Bone.lAn.X, Bone.lAn.Y));
                        esp.DrawLine(Color().Red(), 2.1, Vec22(Bone.rKn.X, Bone.rKn.Y),
                                     Vec22(Bone.rAn.X, Bone.rAn.Y));
                    }
//Box

/* if (isPlayerBox && response.Players[i].Health != 0)
esp.DrawRect(clr, screenHeight / 500, Vec22(x - mx, top),
 Vec22(x + mx, bottom)); 
 */
                    if (isPlayerBox)
                        // esp.DrawCrosshair(Color(0, 0, 0, 255), Vec22(screenWidth / 2, screenHeight / 2), 42);
                        esp.DrawRect(clr, screenHeight / 500, Vec22(x - mx, top),
                                     Vec22(x + mx, bottom));
//Health
                    if (isPlayerHealth) {
                        ...
                        if (Health == 0)
                            ...
                            esp.DrawFilledRect3(clrHealth,
                                                ...
                                                Vec22(x - healthLength +
                                                      (2 * healthLength) *
                                                      Health / 100, top - screenHeight / 110));
                            esp.DrawRect(Color(0, 0, 0), screenHeight / 660,
                                         Vec22(x - healthLength, top - screenHeight / 110),
                                         Vec22(x + healthLength, top - screenHeight / 120));
                        }
                    }
                    if (isEnemyWeapon)
                        if (true) {
...
//Head
                    if (isPlayerHead)
                        esp.DrawHead(Color(0, 255, 255, 255),
                                     Vec22(HeadLocation.X, HeadLocation.Y),
...
//Name and distance
                    ...
                    if (isPlayerDist) {
                        ...
                        esp.DrawTextDistance(Color(30, 0, 255), extra,
                                             Vec22(x + 140, top - 24), textsize);
                    }
                }
            }
    ...
    if (isPlayerename)
        if (botCount + playerCount > 0) {
            ...
            esp.DrawText(Color(0, 255, 0), extra,
                         Vec22(screenWidth / 2 + screenHeight / 8, screenHeight / 10.8),
                         screenHeight / 27);
        } else {
            esp.DrawText(Color(0, 0, 0, 255), "Safe", Vec22(
                    screenWidth / 2, 80), 30);
        }
    if (EspCircle) {
        esp.DrawCircle(Color::Red(), 4, Vec22(screenWidth / 2, screenHeight / 2), 150);
    }
}
