...
public class ESPView extends View implements Runnable {
    ...
    public ESPView(Context context) {
        ...
        InitializePaints();
// Calendar cc = new Calendar.getInstance();
   ...
   */
    ...
    protected void onDraw(Canvas canvas) {
        if (canvas != null && getVisibility() == VISIBLE) {
            ...
            float f = (height - 20);
            DrawText3(canvas, 255, 0, 0, 255, 1.0f, "TELEGRAM: @Z_PM_Z", 180.0f, f, 20.0f);
...
// return !key.equals("");
    ...
    public void InitializePaints() {
        ...
        mRGMTextPaint.setColor(Color.rgb(255, 255, 255));
 ...
 */
    ...
    private String getRGMItemName(String s) {
        ...
        if (s.contains("Bag_Lv1")) {
            mTextPaint.setARGB(255, 127, 154, 250);
            return "Bag lvl 1";
        }

        if (s.contains("Bag_Lv2")) {
            mTextPaint.setARGB(255, 77, 115, 255);
            return "Bag lvl 2";
        }

        if (s.contains("Armor_Lv2")) {
            mTextPaint.setARGB(255, 77, 115, 255);
            return "Vest lvl 2";
        }

        if (s.contains("Armor_Lv1")) {
            mTextPaint.setARGB(255, 127, 154, 250);
            return "Vest lvl 1";
        }

        if (s.contains("Thompson SMG")) {
            mTextPaint.setARGB(255, 52, 224, 63);
            return "Thompson";
        }
        ...
        if (s.contains("MZJ_2X")) {
            mTextPaint.setARGB(255, 52, 224, 63);
            return "2x";
        }
        if (s.contains("MZJ_3X")) {
            mTextPaint.setARGB(255, 52, 224, 63);
            return "3X";
        }

        if (s.contains("MZJ_8X")) {
            mTextPaint.setARGB(255, 247, 99, 245);
            return "8x";
        }

        if (s.contains("MZJ_6X")) {
            mTextPaint.setARGB(255, 247, 99, 245);
            return "6x";
        }

        if (s.contains("MZJ_4X")) {
            mTextPaint.setARGB(255, 247, 99, 245);
            return "4x";
        }
        if (s.contains("MZJ_HD")) {
            mTextPaint.setARGB(255, 247, 99, 245);
            return "Red Dot";
        }
        ...
        if (s.contains("FirstAidbox")) {
            mTextPaint.setARGB(255, 0, 171, 6);
            return "Medkit";
        }

        if (s.contains("Grenade_Shoulei")) {
        ...
        if (s.contains("Kar98k")) {
            mTextPaint.setColor(Color.BLACK);
            return "Kar98k";
        }

        if (s.contains("Ammo_762mm")) {
            mTextPaint.setARGB(255, 92, 36, 28);
            return "7.62";
        }

        if (s.contains("Ammo_556mm")) {
            mTextPaint.setColor(Color.GREEN);
            return "5.56";
        }

        if (s.contains("Bag_Lv3")) {
            mTextPaint.setARGB(255, 36, 83, 255);
            return "Bag lvl 3";
        }

        if (s.contains("PickUpListWrapperActor")) {
            mTextPaint.setARGB(255, 132, 201, 66);
            return "Crate";
        }
        if ((s.contains("AirDropPlane"))) {
            mTextPaint.setARGB(255, 224, 177, 224);
            return "DropPlane";
        }
        if ((s.contains("AirDrop"))) {
        ...
        if (s.contains("Armor_Lv3")) {
            mTextPaint.setARGB(255, 36, 83, 255);
            return "Vest lvl 3";
        }

        if (s.contains("Helmet_Lv2")) {
            mTextPaint.setARGB(255, 77, 115, 255);
            return "Helmet lvl 2";
        }

        if (s.contains("Grenade_Burn")) {
        ...
        if (s.contains("Ghillie")) {
            mTextPaint.setARGB(255, 139, 247, 67);
            return "Ghillie Suit";
        }
        if (s.contains("CheekPad")) {
            mTextPaint.setARGB(255, 112, 55, 55);
            return "CheekPad";
        }

        if (s.contains("Helmet_Lv1")) {
            mTextPaint.setARGB(255, 127, 154, 250);
            return "Helmet lvl 1";
        }

        if (s.contains("Helmet_Lv3")) {
            mTextPaint.setARGB(255, 36, 83, 255);
            return "Helmet lvl 3";
        }

        if (s.contains("Firstaid")) {
            mTextPaint.setARGB(255, 194, 188, 109);
            return "FirstAidKit";
        }
        if (s.contains("Energy Drink")) {
            mTextPaint.setARGB(255, 194, 188, 109);
            return "Energy Drink";
        }

        if (s.contains("Grenade_Smoke")) {
